<?php
$basePath = dirname(__DIR__) . '/voteData/2024總統立委/不分區政黨/';
...
file_put_contents(dirname(__DIR__) . '/data/2024_party_cunli.json', json_encode($result, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));